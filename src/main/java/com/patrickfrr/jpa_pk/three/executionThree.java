package com.patrickfrr.jpa_pk.three;
...
public class executionThree {
    public static void main(String[] args) {
        ...
        // Método do EntityManager find(), SQL nativo, JPQL e JPA Criteria API para realizar uma
